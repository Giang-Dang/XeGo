...
namespace XeGo.Services.Location.API.Controllers
{
    public class DriverLocationController
    {
        ...
        public DriverLocationController(AppDbContext dbContext, IMapper mapper, ILogger<DriverLocationController> logger, IGeoHashService geoHashService, CodeValueGrpcService codeValueGrpcService)
        {
