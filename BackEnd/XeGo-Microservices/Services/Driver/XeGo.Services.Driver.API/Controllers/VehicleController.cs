...
namespace XeGo.Services.Driver.API.Controllers
{
    ...
    public class VehicleController : ControllerBase
    {
        ...
        {
            _logger.LogInformation($"Executing {nameof(DriverController)}>{nameof(GetById)}...");
            ...
            try
            {
                ...
                if (vehicleInfo == null)
                {
                    _logger.LogInformation($"{nameof(DriverController)}>{nameof(GetById)} {vehicleId} : Not found!");
                    ResponseDto.Message = "Not found!";
                    ResponseDto.IsSuccess = true;
                    return ResponseDto;
                }

                _logger.LogInformation($"{nameof(DriverController)}>{nameof(GetById)} {vehicleId} : Found!");
                ResponseDto.IsSuccess = true;
