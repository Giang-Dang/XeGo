...
namespace XeGo.Services.Vehicle.API.Migrations
{
    ...
    [Migration("20231122075053_seedData_VehicleType2")]
    partial class seedData_VehicleType2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("XeGo.Services.Vehicle.API.Entities.VehicleType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "ADMIN",
                            CreatedDate = new DateTime(2023, 11, 22, 7, 50, 52, 770, DateTimeKind.Utc).AddTicks(7857),
                            IsActive = true,
                            LastModifiedBy = "ADMIN",
                            LastModifiedDate = new DateTime(2023, 11, 22, 7, 50, 52, 770, DateTimeKind.Utc).AddTicks(7857),
                            Name = "4-seater Car"
                        },
                        new
                        {
                            Id = 2,
                            CreatedBy = "ADMIN",
                            CreatedDate = new DateTime(2023, 11, 22, 7, 50, 52, 770, DateTimeKind.Utc).AddTicks(7860),
                            IsActive = true,
                            LastModifiedBy = "ADMIN",
                            LastModifiedDate = new DateTime(2023, 11, 22, 7, 50, 52, 770, DateTimeKind.Utc).AddTicks(7861),
                            Name = "7-seater Car"
                        });
                });
